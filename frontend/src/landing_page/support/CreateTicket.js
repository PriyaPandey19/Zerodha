        ...
        <div className='container'>
            <div className='row p-5 mt-5 mb-5'>
                ...
                <a href=""style={{textDecoration:"none",lineHeight:"2.5"}}>Transfer And Conversion of Shares</a><br/>
                  ...
                  <div className='col-4 p-5 mt-2 mb-2'>
                <h4 className=''><i class="fa fa-eercast" aria-hidden="true"></i> Kite</h4>
                <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Margin/levearge, Product and Order types</a><br/>
                ...
                <a href=""style={{textDecoration:"none",lineHeight:"2.5"}}>Adding Bank Accounts</a><br/>
                  ...
                  <div className='col-4 p-5 mt-2 mb-2'>
                <h4 className=''><i class="fa fa-ravelry" aria-hidden="true"></i> Console</h4>
                ...
                <a href=""style={{textDecoration:"none",lineHeight:"2.5"}}>Referral Program</a><br/>
                  ...
                  <div className='col-4 p-5 mt-2 mb-2'>
                <h4 className=''><i class="fa fa-handshake-o" aria-hidden="true"></i> Coin</h4>
